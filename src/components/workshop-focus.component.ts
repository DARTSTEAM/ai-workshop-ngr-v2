...
@Component({
    ...
    <section class="container mx-auto px-6 mb-24 pt-20 -mt-20">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <!-- Block 2 -->
        <div class="bg-[#7E6E94] text-white rounded-3xl p-10 shadow-xl relative overflow-hidden group">
          ...
          <div class="flex items-center gap-4 mb-8">
            <span class="text-5xl font-black text-white">2️⃣</span>
            <div>
              <h3 class="text-2xl font-bold">Full Hands-On</h3>
              <p class="text-[#D8B4E2] font-semibold">Ejecución práctica con n8n</p>
            </div>
          </div>

          <p class="text-white/80 mb-6 font-light">La segunda parte es 100% práctica. Dividimos a los participantes en equipos y trabajamos en casos reales.</p>
          
          <div class="space-y-4 mb-8">
            <div class="p-4 bg-white/10 rounded-2xl border border-white/10 backdrop-blur-sm">
              <p class="text-sm">Cada equipo desarrolla su automatización y presenta:</p>
              <ul class="mt-3 grid grid-cols-2 gap-2 text-xs">
                <li class="flex items-center gap-2">
                  <div class="w-1.5 h-1.5 rounded-full bg-[#F4EB33]"></div> Problema abordado
                </li>
                <li class="flex items-center gap-2">
                  <div class="w-1.5 h-1.5 rounded-full bg-[#F4EB33]"></div> Solución diseñada
                </li>
                <li class="flex items-center gap-2">
                  <div class="w-1.5 h-1.5 rounded-full bg-[#F4EB33]"></div> Flujo construido
                </li>
                <li class="flex items-center gap-2">
                  <div class="w-1.5 h-1.5 rounded-full bg-[#F4EB33]"></div> Resultado en vivo
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="mt-8 p-4 bg-white/5 rounded-2xl border border-white/10">
            <p class="text-sm text-white/90 italic font-light">
